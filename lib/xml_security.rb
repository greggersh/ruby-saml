...
module XMLSecurity
  ...
  class SignedDocument < REXML::Document
    ...
    def validate_signature(base64_cert, soft = true)
      ...
      # verify signature
      signed_info_element     = REXML::XPath.first(@working_copy, "//ds:SignedInfo", {"ds"=>DSIG})
      ...
      base64_signature        = REXML::XPath.first(@working_copy, "//ds:SignatureValue", {"ds"=>DSIG}).text
